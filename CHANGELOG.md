...
### SUG-720 Breaking chcnges

- В пользовательский метод onSearchError третьим аргументом передается Promise (аналог нативного Promise, появившегося в ES6), раньше передавался jqXhr
